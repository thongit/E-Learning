...
<body>
                ...
                <ul class="navbar-nav">
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="admin-img">
                                <img src="{{ asset('assets-admin/img/figure/admin.jpg') }}" alt="Admin">
                            </div>
                        </a>
                            ...
                            <div class="item-content">
                                <div class="media">
                                    <div class="item-img bg-skyblue author-online">
                                        <img src="{{ asset('assets-admin/img/figure/student11.png') }}" alt="img">
                                    </div>
                                ...
                                <div class="media">
                                    <div class="item-img bg-yellow author-online">
                                        <img src="{{ asset('assets-admin/img/figure/student12.png') }}" alt="img">
                                    </div>
                                    <div class="media-body space-sm">
                                        <div class="item-title">
                                            <a href="#">
                                ...
                                <div class="media">
                                    <div class="item-img bg-pink">
                                        <img src="{{ asset('assets-admin/img/figure/student13.png') }}" alt="img">
                                    </div>
                                    <div class="media-body space-sm">
                                        <div class="item-title">
                                            <a href="#">
        ...
        <div class="dashboard-page-one">
            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
               <div class="mobile-sidebar-header d-md-none">
                    <div class="header-logo">
                        <a href="index.html"><img src="{{ asset('assets-admin/img/logo1.png') }}" alt="logo"></a>
                    </div>
               </div>
                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ asset('assets-admin/img/figure/student2.png') }}" alt="student"></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ asset('assets-admin/img/figure/student3.png') }}" alt="student"></td>
                                        <td>Jessia Rose</td>
                                        <td>Female</td>
                                        <td>1</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ asset('assets-admin/img/figure/student4.png') }}" alt="student"></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ asset('assets-admin/img/figure/student5.png') }}" alt="student"></td>
                                        <td>Jessia Rose</td>
                                        <td>Female</td>
                                        <td>1</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ asset('assets-admin/img/figure/student6.png') }}" alt="student"></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ asset('assets-admin/img/figure/student7.png') }}" alt="student"></td>
                                        <td>Jessia Rose</td>
                                        <td>Female</td>
                                        <td>1</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ asset('assets-admin/img/figure/student8.png') }}" alt="student"></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ asset('assets-admin/img/figure/student9.png') }}" alt="student"></td>
                                        <td>Jessia Rose</td>
                                        <td>Female</td>
                                        <td>1</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ asset('assets-admin/img/figure/student10.png') }}" alt="student"></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>A</td>
    ...
    <!-- Popper js -->
    <scriptsrc="{{ asset('assets-admin/js/popper.min.js') }}"></script>
    <!-- Bootstrap js -->
