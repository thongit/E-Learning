...
$(document).ready(function(){
	...
	function populateQuestion(ques,index){
		...
		if(!Array.isArray(ques[4]) || ques[4].length > 0)
		{
		...
		if(!Array.isArray(ques[5]) || ques[5].length > 0)
		{
		...
		if(!Array.isArray(ques[6]) || ques[6].length > 0)
		{
		...
		if(!Array.isArray(ques[7]) || ques[7].length > 0)
		{
