...
Route::middleware('auth')->group(function(){
    ...
    Route::get('admin/khoa-hoc-hoc-vien/{id}','AdminController@getKhoaHocHocVien')->name('admin-ds-khoa-hoc-hoc-vien');
...
Route::get('giang-vien-pagin','KhoaHocController@getGiangVienPagin');
...
Route::get('loc-danh-gia','KhoaHocController@locDanhGia')->name('loc-danh-gia');
